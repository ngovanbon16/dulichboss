...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url, dta;
            url = "<?php echo base_url(); ?>index.php/diadiem/countAll";
            ...
            function load(page)
            {
                ...
                var url = "<?php echo base_url(); ?>index.php/diadiem/data1/"+size+"/"+star;
                // prepare the data
                var source =
                {
                    datatype: "json",
                ...
                $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        { text: 'Mã', dataField: 'DD_MA', width: "5%", cellsalign: 'center' },
                        { text: 'Loại địa điểm', dataField: 'DM_TEN', width: "17%", filtertype: 'checkedlist' },
                        /*{ text: 'Mã người dùng', dataField: 'ND_MA', width: "10%" },*/
                        { text: 'Tên địa điểm', dataField: 'DD_TEN', width: "18%" },
                        { text: 'Duyệt', dataField: 'DD_DUYET', width: "5%", columntype: 'checkbox', filtertype: 'bool' },
                        { text: 'Ngày cập nhật', dataField: 'DD_NGAYCAPNHAT', width: "11%", columntype: 'datetimeinput', filtertype: 'range', cellsformat: 'd', cellsalign: 'right' },
